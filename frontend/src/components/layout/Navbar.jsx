            ...
            <div className="absolute right-0 mt-2 w-64 bg-white border border-slate-100 rounded-2xl shadow-xl shadow-slate-100/50 py-2.5 transition-all duration-200">
              ...
              <div className="p-1.5">
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-semibold text-red-600 hover:text-white bg-red-50/50 hover:bg-red-500 rounded-lg transition-all duration-200 cursor-pointer border-none"
                >
                  <LogOut size={14} />
                  Sign Out
                </button>
